**[conditions](conditions.md#Blinded):** All terrain is difficult. Critically fail vision-based [skills](skills.md#Perception) checks and -4 status penalty to other [skills](skills.md#Perception) Checks.
