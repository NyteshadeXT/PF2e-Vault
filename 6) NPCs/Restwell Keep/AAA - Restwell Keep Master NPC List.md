...
```yaml:dbfolder
name: new database
description: Database contains information for all NPCs found in Restwell Keep.
columns:
  __file__:
    key: __file__
    id: __file__
  ...
  Race:
    ...
    options:
      ...
      - { label: "Elf - Arctic", value: "Arctic Elf", color: "hsl(16, 95%, 90%)"}
      - { label: "Elf - Cavern", value: "Cavern Elf", color: "hsl(16, 95%, 90%)"}
      - { label: "Elf - Seer", value: "Seer Elf", color: "hsl(16, 95%, 90%)"}
      - { label: "Elf - Whisper", value: "Whisper Elf", color: "hsl(16, 95%, 90%)"}
      - { label: "Elf - Woodland", value: "Wood Elf", color: "hsl(16, 95%, 90%)"}
      - { label: "Halfling - Gutsy", value: "Gutsy Halfling", color: "hsl(269, 95%, 90%)"}
      - { label: "Halfling - Hillock", value: "Hillock Halfling", color: "hsl(200, 95%, 90%)"}
      - { label: "Halfling - Nomadic", value: "Nomad Halfling", color: "hsl(200, 95%, 90%)"}
      - { label: "Halfling - Twilight", value: "Twilight Halfling", color: "hsl(200, 95%, 90%)"}
      - { label: "Halfling - Wildwood", value: "Wildwood Halfling", color: "hsl(200, 95%, 90%)"}
      - { label: "Gnome - Chameleon", value: "Chameleon Gnome", color: "hsl(341, 95%, 90%)"}
      - { label: "Gnome - Fey-Touched", value: "Fey-Touched Gnome", color: "hsl(341, 95%, 90%)"}
      - { label: "Gnome - Sensate", value: "Sensate Gnome", color: "hsl(341, 95%, 90%)"}
      - { label: "Gnome - Umbral", value: "Umbral Gnome", color: "hsl(341, 95%, 90%)"}
      - { label: "Gnome - Wellspring", value: "Wellspring Gnome", color: "hsl(341, 95%, 90%)"}
      - { label: "Dwarf - Ancient-Blooded", value: "Ancient-Blooded Dwarf", color: "hsl(183, 95%, 90%)"}
      - { label: "Dwarf - Forge", value: "Forge Dwarf", color: "hsl(184,96%,90%)"}
      - { label: "Dwarf - Rock", value: "Rock Dwarf", color: "hsl(184,96%,90%)"}
      - { label: "Dwarf - Death Watch", value: "Death Watch Dwarf", color: "hsl(184,96%,90%)"}
      - { label: "Dwarf - Strong-Blooded", value: "Strong-Blooded Dwarf", color: "hsl(184,96%,90%)"}
      - { label: "Goblin - Charhide", value: "Charhide Goblin", color: "hsl(200, 95%, 90%)"}
      - { label: "Goblin - Irongut", value: "Irongut Goblin", color: "hsl(200, 95%, 90%)"}
      - { label: "Goblin - Razertooth", value: "Razertooth Goblin", color: "hsl(200, 95%, 90%)"}
      - { label: "Goblin - Snow", value: "Snow Goblin", color: "hsl(200, 95%, 90%)"}
      - { label: "Goblin - Unbreakable", value: "Unbreakable Goblin", color: "hsl(200, 95%, 90%)"}
      - { label: "ElfSeer", value: "ElfSeer", color: "hsl(208, 95%, 90%)"}
      - { label: "ElfWood", value: "ElfWood", color: "hsl(180, 95%, 90%)"}
      - { label: "DwarfRock", value: "DwarfRock", color: "hsl(341, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
  ...
  Condition:
    ...
    options:
      ...
      - { label: "Diseased", value: "Diseased", color: "hsl(280, 95%, 90%)"}
  ...
  Location:
    ...
    sortIndex: -1
    options:
      - { label: "Crossroads", value: "Crossroads", color: "hsl(280, 95%, 90%)"}
      - { label: "Restwell Keep", value: "Restwell Keep", color: "hsl(280, 95%, 90%)"}
      - { label: "Winterspring", value: "Winterspring", color: "hsl(280, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
  ...
  Occupation:
    ...
    options:
      ...
      - { label: "Banker", value: "Banker", color: "hsl(66, 95%, 90%)"}
      ...
      - { label: "Mercernary", value: "Mercernary", color: "hsl(194, 95%, 90%)"}
      - { label: "Merchant", value: "Merchant", color: "hsl(140, 95%, 90%)"}
      - { label: "Miner", value: "Miner", color: "hsl(140, 95%, 90%)"}
